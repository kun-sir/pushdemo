...
public class PushMsgService extends AliPushRcvService {
    ...
    protected void handleActionReceived(String msgKey, String msgValue, boolean clicked) {
        ...
        if (clicked) {
            ...
            //自己渠道推送 获取数据自己弹出通知
            // show your notification and handle action TODO
